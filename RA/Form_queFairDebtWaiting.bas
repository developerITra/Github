...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queFairDebtWaiting"
...
Private Sub cmdExcel_Click()
    ...
    DoCmd.OutputTo acOutputQuery, "qryQueueFairDebtWaiting", acFormatXLS, TemplatePath & "FairDebt Waiting Queue info.xlt", True
...
Forms!wizfairdebt!ComLable.Visible = True
...
With rstqueue
.Edit
If IsNull(!FairDebtUser) Then !FairDebtUser = StaffID
!FairDebtWaitingLastEdited = Date
!FairDebtWaitingUser = GetStaffID
.Update
End With
Set rstqueue = Nothing
End Sub
