...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queAttyMilestone5Mgr"
...
Dim cntr As Integer
Set rstqueue = CurrentDb.OpenRecordset("Select * FROM qryqueueAttymilestone5Mgr", dbOpenDynaset, dbSeeChanges)
...
'lisa
    ...
    strSQLJournal = "Insert into Journal (FileNumber,JournalDate,Who,Info,Color) Values(Forms!queAttyMilestone5Mgr!lstFiles,Now,GetFullName(),'" & strinfo & "',1 )"
