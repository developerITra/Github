...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Report_Loss Mitigation Preliminary MDHCD"
...
If page = 1 Then Call DrawBarcode(Me, AddDocPreIndex([FileNumber], 1484, ""), 450, 7000, True)

If Forms![Case List]![ClientID] = 456 Then
    Me.Caption = "Loss Mitigation Preliminary M&T"
Else
Me.Caption = "Loss Mitigation Preliminary MDHC"
End If
