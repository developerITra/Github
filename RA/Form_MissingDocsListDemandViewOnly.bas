...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_MissingDocsListDemandViewOnly"
...
'!JournalDate = Now
'!Who = GetFullName
'!Info = DocName & "was manually removed from the demand waiting list of outstanding items"
'.Update
'.Close
'End With

DoCmd.SetWarnings False
strinfo = DocName & "was manually removed from the demand waiting list of outstanding items"
