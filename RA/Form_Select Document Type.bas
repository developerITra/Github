...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_Select Document Type"
...
If IsLoaded("Case List") Then
    If Forms![Case List]!Page97.Visible = False Then
        If IsLoaded("ForeclosureDetails") Then
            If Forms!foreclosuredetails!WizardSource = "Title" Then
            Forms![Select Document type]!optQuickPick.Visible = False
            End If
        End If
    End If
End If
...
If IsLoaded("ForeclosureDetails") Then
    ...
    Forms![Select Document type]!lstDocType.Visible = False
    Forms![Select Document type]!Toggle13.Visible = False
    End If
End If
 
 If BillTitle = True Then
    Forms![Select Document type]!Toggle14.Visible = True
    Forms![Select Document type]!Toggle11.Visible = False
    Forms![Select Document type]!Toggle12.Visible = False
 End If
 If BillTitleUpdate = True Then
    Forms![Select Document type]!Toggle15.Visible = True
    Forms![Select Document type]!Toggle11.Visible = False
    Forms![Select Document type]!Toggle12.Visible = False
 End If
...
If IsLoaded("Case List") Then
    ...
    Forms![Select Document type]!SCRAMilitary.Visible = True
    Forms![Select Document type]!SSNSRCA.Visible = True
    Forms![Select Document type]!lstDocType.Visible = False
    Forms![Select Document type]!Toggle11.Visible = False
    Forms![Select Document type]!Toggle12.Visible = False
    Forms![Select Document type]!Toggle13.Visible = False
    Forms![Select Document type]!Toggle14.Visible = False
    End If
 End If
