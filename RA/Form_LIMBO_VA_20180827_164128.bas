...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_LIMBO_VA"
...
DoCmd.OpenForm "QueueRules", , , "ruleid = " & 2
End Sub

Private Sub ComSendExcel_Click()
    DoCmd.SetWarnings False
    DoCmd.OutputTo acOutputQuery, "LimboVAExcel", acFormatXLS, TemplatePath & "Limbo VA All colores.xlt", True
...
rstqueue = DCount("filenumber", "LimboVA")
QueueCount = rstqueue

rstqueueY = DCount("filenumber", "LimboVA_Yellow")
QueueCountY = rstqueueY

rstqueueR = DCount("filenumber", "LimboVA_Red")
...
AddToList (lstFiles)
Call Limbo_OpenWizard(Me.lstFiles, "Limbo_VA", "White")
End Sub
...
AddToList (lstFilesR)
Call Limbo_OpenWizard(Me.lstFilesR, "Limbo_VA", "Red")
End Sub
...
AddToList (lstFilesY)
Call Limbo_OpenWizard(Me.lstFilesY, "Limbo_VA", "yellow")
End Sub
