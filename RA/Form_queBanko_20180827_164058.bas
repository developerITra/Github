...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queBanko"
...
Set rstqueue = CurrentDb.OpenRecordset("Select * FROM qryQueueBanko where File=" & lstFiles, dbOpenDynaset, dbSeeChanges)
...
DoCmd.SetWarnings False
strinfo = "BANKRUPTCY FOUND IN LEXIS/NEXIS MONITORING: Case Number:" & rstbk.Fields("CaseNumber") & " Chapter:" & rstbk.Fields("Chapter") & " File Date:" & rstbk.Fields("FileDate") & " Disposition:" & rstbk.Fields("DispositionCode") & " City Filed:" & rstbk.Fields("CityFiled") & " StateFiled:" & rstbk.Fields("StateFiled") & " County:" & rstbk.Fields("County") & " FirstName:" & rstbk.Fields("FirstName") & " LastName:" & rstbk.Fields("LastName") & " Debtors City:" & rstbk.Fields("DebtorsCity") & " Debtors State:" & rstbk.Fields("DebtorsState") _
& " Law Firm:" & rstbk.Fields("LawFirm") & " Attorney Name:" & rstbk.Fields("AttorneyName") & " Attorney Address:" & rstbk.Fields("AttorneyAddress") & " Attorney City:" & rstbk.Fields("AttorneyCity") & " Attorney State:" & rstbk.Fields("AttorneyState") & " Attorney Zip:" & rstbk.Fields("AttorneyZip") & " AttorneyPhone:" & rstbk.Fields("AttorneyPhone") & " 341 Date:" & rstbk.Fields("341Date") & " 341 Time:" & rstbk.Fields("341Time") & " 341 Location:" & rstbk.Fields("341Location") & " Trustee:" & rstbk.Fields("Trustee") & " Trustee Address:" & rstbk.Fields("TrusteeAddress") _
 & " Trustee City:" & rstbk.Fields("TrusteeCity") & " Trustee State:" & rstbk.Fields("TrusteeState") & " Trustee Zip:" & rstbk.Fields("TrusteeZip") & " Trustee Phone:" & rstbk.Fields("TrusteePhone") & " Judges Initials:" & rstbk.Fields("JudgesInitials") & " Court District:" & rstbk.Fields("CourtDistrict") & " Court Phone:" & rstbk.Fields("CourtPhone") & " Debtor Phone:" & rstbk.Fields("DebtorPhone") & " Voluntary or Involuntary Dismissal:" & rstbk.Fields("VoluntaryInvoluntaryDismissal") & " Proof Of Claim Date:" & rstbk.Fields("ProofOfClaimDate")
strinfo = Replace(strinfo, "'", "''")
strSQLJournal = "Insert into Journal (FileNumber,JournalDate,Who,Info,Color) Values(" & lstFiles & ",Now,GetFullName(),'" & strinfo & "',1 )"
...
Set rstbk = CurrentDb.OpenRecordset("Select * FROM qryQueueBankoALLINFO where File=" & ListS, dbOpenDynaset, dbSeeChanges)

Set rstqueue = CurrentDb.OpenRecordset("Select * FROM qryQueueBankoSSNOnly where File=" & ListS, dbOpenDynaset, dbSeeChanges)
...
'!JournalDate = Now
'!Who = GetFullName
'!Info = "BANKRUPTCY FOUND IN LEXIS/NEXIS MONITORING NOT MATCH NAMES ONLY SSN: Case Number:" & rstbk.Fields("CaseNumber") & " Chapter:" & rstbk.Fields("Chapter") & " File Date:" & rstbk.Fields("FileDate") & " Disposition:" & rstbk.Fields("DispositionCode") & " City Filed:" & rstbk.Fields("CityFiled") & " StateFiled:" & rstbk.Fields("StateFiled") & " County:" & rstbk.Fields("County") & " FirstName:" & rstbk.Fields("FirstName") & " LastName:" & rstbk.Fields("LastName") & " Debtors City:" & rstbk.Fields("DebtorsCity") & " Debtors State:" & rstbk.Fields("DebtorsState") _
'& " Law Firm:" & rstbk.Fields("LawFirm") & " Attorney Name:" & rstbk.Fields("AttorneyName") & " Attorney Address:" & rstbk.Fields("AttorneyAddress") & " Attorney City:" & rstbk.Fields("AttorneyCity") & " Attorney State:" & rstbk.Fields("AttorneyState") & " Attorney Zip:" & rstbk.Fields("AttorneyZip") & " AttorneyPhone:" & rstbk.Fields("AttorneyPhone") & " 341 Date:" & rstbk.Fields("341Date") & " 341 Time:" & rstbk.Fields("341Time") & " 341 Location:" & rstbk.Fields("341Location") & " Trustee:" & rstbk.Fields("Trustee") & " Trustee Address:" & rstbk.Fields("TrusteeAddress") _
' & " Trustee City:" & rstbk.Fields("TrusteeCity") & " Trustee State:" & rstbk.Fields("TrusteeState") & " Trustee Zip:" & rstbk.Fields("TrusteeZip") & " Trustee Phone:" & rstbk.Fields("TrusteePhone") & " Judges Initials:" & rstbk.Fields("JudgesInitials") & " Court District:" & rstbk.Fields("CourtDistrict") & " Court Phone:" & rstbk.Fields("CourtPhone") & " Debtor Phone:" & rstbk.Fields("DebtorPhone") & " Voluntary or Involuntary Dismissal:" & rstbk.Fields("VoluntaryInvoluntaryDismissal") & " Proof Of Claim Date:" & rstbk.Fields("ProofOfClaimDate")
'!Color = 1
'.Update
...
DoCmd.SetWarnings False
strinfo = "BANKRUPTCY FOUND IN LEXIS/NEXIS MONITORING NOT MATCH NAMES ONLY SSN: Case Number:" & rstbk.Fields("CaseNumber") & " Chapter:" & rstbk.Fields("Chapter") & " File Date:" & rstbk.Fields("FileDate") & " Disposition:" & rstbk.Fields("DispositionCode") & " City Filed:" & rstbk.Fields("CityFiled") & " StateFiled:" & rstbk.Fields("StateFiled") & " County:" & rstbk.Fields("County") & " FirstName:" & rstbk.Fields("FirstName") & " LastName:" & rstbk.Fields("LastName") & " Debtors City:" & rstbk.Fields("DebtorsCity") & " Debtors State:" & rstbk.Fields("DebtorsState") _
& " Law Firm:" & rstbk.Fields("LawFirm") & " Attorney Name:" & rstbk.Fields("AttorneyName") & " Attorney Address:" & rstbk.Fields("AttorneyAddress") & " Attorney City:" & rstbk.Fields("AttorneyCity") & " Attorney State:" & rstbk.Fields("AttorneyState") & " Attorney Zip:" & rstbk.Fields("AttorneyZip") & " AttorneyPhone:" & rstbk.Fields("AttorneyPhone") & " 341 Date:" & rstbk.Fields("341Date") & " 341 Time:" & rstbk.Fields("341Time") & " 341 Location:" & rstbk.Fields("341Location") & " Trustee:" & rstbk.Fields("Trustee") & " Trustee Address:" & rstbk.Fields("TrusteeAddress") _
 & " Trustee City:" & rstbk.Fields("TrusteeCity") & " Trustee State:" & rstbk.Fields("TrusteeState") & " Trustee Zip:" & rstbk.Fields("TrusteeZip") & " Trustee Phone:" & rstbk.Fields("TrusteePhone") & " Judges Initials:" & rstbk.Fields("JudgesInitials") & " Court District:" & rstbk.Fields("CourtDistrict") & " Court Phone:" & rstbk.Fields("CourtPhone") & " Debtor Phone:" & rstbk.Fields("DebtorPhone") & " Voluntary or Involuntary Dismissal:" & rstbk.Fields("VoluntaryInvoluntaryDismissal") & " Proof Of Claim Date:" & rstbk.Fields("ProofOfClaimDate")
strinfo = Replace(strinfo, "'", "''")
...
AddStatus ListS, Date, "Lexis/Nexis BK Hit Identified and Noted in File."
