...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_AdvPostSaleCostPkg_Orig"
...
If Forms!AdvPostSaleCostPkg!sfrmPostSaleAdvanceCost!Description = "Attorney Fee" Or Forms!AdvPostSaleCostPkg!sfrmPostSaleAdvanceCost!Description = "Property Registration Fee" Then
