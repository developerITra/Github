...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_sfrmSort"
...
Then
Else
If s = "Atty Review" Or s = "date" Then sfrmSort_frmSortOrder.Value = 1
    Call RunSort(s)
    On Error Resume Next
    .Value = s
    On Error GoTo 0
...
Then
    ...
    s = s & " [" & sFld & "]"
        ...
        If 1 = sfrmSort_frmSortOrder.Value Then s = s & " asc"
