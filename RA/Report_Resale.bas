...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Report_Resale"
...
If IsNull(txtLetterDate) Then
    txtLetterDate = InputBox$("Enter date of letter advising purchaser to settle:")
    If Nz(txtLetterDate) = "" Then Cancel = 1
End If
End Sub
