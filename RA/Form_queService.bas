...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queService"
...
Set rstqueue = CurrentDb.OpenRecordset("Select * FROM qryqueueProcessService", dbOpenDynaset, dbSeeChanges)
