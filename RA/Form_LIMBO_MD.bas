...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_LIMBO_MD"
...
DoCmd.OpenForm "QueueRules", , , "ruleid = " & 1

End Sub

Private Sub ComSendExcel_Click()
    DoCmd.SetWarnings False
    DoCmd.OutputTo acOutputQuery, "LimboMDExcel", acFormatXLS, TemplatePath & "Limbo MD All colores.xlt", True
...
rstqueue = DCount("filenumber", "LimboMD")
QueueCount = rstqueue

rstqueueY = DCount("filenumber", "LimboMD_Yellow")
QueueCountY = rstqueueY

rstqueueR = DCount("filenumber", "LimboMD_Red")
...
AddToList (lstFiles)
Call Limbo_OpenWizard(Me.lstFiles, "Limbo_MD", "White")
End Sub
...
AddToList (lstFilesR)
Call Limbo_OpenWizard(Me.lstFilesR, "Limbo_MD", "Red")
End Sub
...
AddToList (lstFilesY)
Call Limbo_OpenWizard(Me.lstFilesY, "Limbo_MD", "Yellow")
End Sub
