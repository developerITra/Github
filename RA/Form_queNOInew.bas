...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queNOInew"
...
DoCmd.SetWarnings False
    DoCmd.OutputTo acOutputQuery, "qryQueueNOI", acFormatXLS, TemplatePath & "NOI Queue info.xlt", True
...
'If DLookup("Status", "qryqueuenoi", lstFiles) = "Locked" Then
'MsgBox "File is locked, please select another", vbCritical
'Exit Sub
'End If
...
Forms!wizNOI!cmdOK.Visible = False
