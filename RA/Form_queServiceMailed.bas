...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queServiceMailed"
...
ServiceMailedCallFromQueue lstFiles
...
With rstqueue
.Edit
!ServiceMailedUser = StaffID
!ServiceMailedLastEdited = Date
.Update
End With
...
Set rstqueue = CurrentDb.OpenRecordset("Select * FROM qryQueueNoticeToOccupant_P", dbOpenDynaset, dbSeeChanges)
