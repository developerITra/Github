...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_GetPostageFLMASentToCourt"
...
If txtTotal2 <> 0# Then AddInvoiceItem Forms![Case List]!FileNumber, txtProcess2, txtDesc2, txtTotal2, Frame33, False, True, False, True
...
txtProcess2 = Split(Me.OpenArgs, "|")(4)
txtDesc2 = Split(Me.OpenArgs, "|")(5)
