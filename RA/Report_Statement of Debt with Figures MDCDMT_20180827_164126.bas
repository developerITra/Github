...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Report_Statement of Debt with Figures MDCDMT"
...
Me.Caption = "Statement of Debt with Figures M&T"
    Else
Me.Caption = "Statement of Debt with Figures MDCDMT"
End If
