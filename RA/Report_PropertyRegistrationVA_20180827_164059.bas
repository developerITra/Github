...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Report_PropertyRegistrationVA"
...
If Me.Text112 = "VA" Then
    Call FirmMarginVA(Me, FileNumber, , PrimaryDefName, Property)
Else
    Call FirmMargin(Me, FileNumber, , PrimaryDefName, Property)
End If
