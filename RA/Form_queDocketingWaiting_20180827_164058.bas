...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queDocketingWaiting"
...
Call DoReport("qryqueuedocketingwaiting", -3)
End Sub

Private Sub cmdOK_Click()
Dim rstqueue As Recordset
On Error GoTo Err_cmdOK_Click
If Forms!queDocketingWaiting!lstFiles.Column(9) = "2. Rejected" Then Rejection = True

DocketingWaitingCallFromQueue lstFiles
...
With rstqueue
.Edit
!DocketingWaitingUser = StaffID
!DocketingWaitingLastEdited = Date
.Update
End With
...
DoCmd.OpenForm "MissingDocsListdocketingviewonly"
Forms!MissingDocsListdocketingviewonly!FileNbr = lstFiles
End Sub
...
DocketingWaitingCallFromQueue lstfilesRed
