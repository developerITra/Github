...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queFairDebt"
...
Private Sub cmdExcel_Click()
    ...
    DoCmd.OutputTo acOutputQuery, "qryQueueFairDebt", acFormatXLS, TemplatePath & "FairDebt Queue info.xlt", True
...
Set rstqueue = CurrentDb.OpenRecordset("Select * FROM qryqueueFairDebt", dbOpenDynaset)
...
AddToList (lstFiles)
FairDebtCallFromQueue lstFiles
'Forms!wizFairDebt!cmdOK.Caption = "Sent to Atty"
Forms!wizfairdebt!comSentAtty.Visible = True
Forms!wizfairdebt!cmdOK.Visible = False
'Forms!wizFairDebt!cmdOK.FontBold = True
'Forms!wizFairDebt!cmdOK.ForeColor = vbGreen
...
FairDebtCallFromQueue lstfilesRed
Forms!wizfairdebt!cmdOK.Caption = "Sent to Atty"
