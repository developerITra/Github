...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Report_Declaration Wells"
...
If Not IsNull(Forms![Print Declaration]![chExhibit]) Then
Forms![Print Exhibit 9].Visible = True
End If
...
If Not IsNull(Forms![Print Declaration].chExhibit) Then
Forms![Print Exhibit 9].Visible = False
End If
...
'Else
Call FirmMargin(Me, FileNumber, , PrimaryDefName, PropertyAddress, , Nz(Forms!BankruptcyDetails!sfrmPropAddr!Apt))
'End If
