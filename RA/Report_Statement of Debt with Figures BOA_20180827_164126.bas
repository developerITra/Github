...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Report_Statement of Debt with Figures BOA"
...
Private Sub Report_Page()
    ...
    Call FirmMargin(Me, Forms![Print Statement of Debt]!FileNumber, , Forms!foreclosuredetails!PrimaryDefName, Forms!foreclosuredetails!PropertyAddress, , Nz(Forms!foreclosuredetails![Fair Debt]))
    If page = 1 Then Call DrawBarcode(Me, AddDocPreIndex(Forms![Print Statement of Debt]!FileNumber, 223, ""), 450, 7000, True)
End Sub
'2012.02.09 Davw: Changed:
'IIf(([RemainingPBal]>[OriginalPBal]),"Additional Interest","Paid on principal")
'=[OriginalPBal]-[RemainingPBal]
Private Function LastMonth(LPIDate As Date)
