...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_queRSII"
...
Private Sub cmdExcel_Click()
    ...
    DoCmd.OutputTo acOutputQuery, "qryQueueRSII", acFormatXLS, TemplatePath & "RSII Queue info.xlt", True
...
'If DLookup("Status", "qryqueueRSII", lstFiles) = "Locked" Then
'MsgBox "File is locked, please select another", vbCritical
'Exit Sub
'End If


RSIICallFromQueue lstFiles
